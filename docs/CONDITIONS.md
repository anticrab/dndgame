...
| Grappled (V2) | — | — | — | скорость 0 (guard в `MoveAction`) |
| Hidden (V2) | — | — | — | self-**преимущество** на атаку; снимается после удара |
...
**V2-упрощения:** Grappled — без побега-состязания и перетаскивания; Hidden —
лёгкая версия (только self-преимущество + снятие после удара), без полного
стелса («не виден» → помеха атакам по тебе, прерывание скрытности движением,
LoS). См. `docs/SKILLS.md` и план этапа V.
