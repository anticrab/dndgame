...
Бывалый воин 1-го уровня (с запасом XP у порога) против двух гоблинов.
Подведите воина к врагу (`m` — движение, `a` — атака). На **первом же**
убийстве всплывёт окно level-up — «Сейчас!» поднимет воина до 2 уровня прямо
в бою (+HP и новая способность **Action Surge** на `x`). Добейте второго
гоблина — победа.
